...
List<Detail> details = [
  Detail(
    photo: "https://www.conserve-energy-future.com/wp-content/uploads/2016/02/battery-recycling.jpg",
    title: 'Battery',
    about:
        'Various types of batteries are widely used in daily life, and a large number of waste batteries are eventually produced. Waste batteries causes serious environmental pollution',
    methods: '''
  ...
  Detail(
    ...
    about:
        'Glass does not decompose, it is important to recycle it. Glass is almost 100% recyclable and can be recycled endlessly without loss in quality or purity',
    methods: '''
  ...
  Detail(
    photo: "https://in.apparelresources.com/wp-content/uploads/sites/3/2021/08/unnamed.jpg",
    title: 'Textile Waste',
    about:
        'Current fashion system uses high volumes of non-renewable resources, including petroleum, extracted to produce clothes that are often used only for a short period of time, after which the materials are largely lost to landfill or incineration',
    methods: '''
  ...
  Detail(
    photo: "https://www.recyclingdepotadelaide.com.au/wp-content/uploads/2015/04/scrap-metal-recycling-process.jpg",
    title: 'Metal Waste',
    about:
  ...
  Detail(
    photo: "https://marketresearch.biz/wp-content/uploads/2019/01/plastic-waste-management-market.jpg",
    title: 'Plastic Waste',
    about:
        ' A significant amount of plastic waste has entered the environment, creating a health hazard for humans and, more importantly, life-threatening situations for animals, particularly ocean life. A large percentage of plastic waste remains unattended, giving rise to an important situation that must be dealt with by plastic manufacturers and end users.',
    methods: '''
  ...
  Detail(
    photo: "https://www.conserve-energy-future.com/wp-content/uploads/2021/01/sneaker-made-from-shoes.jpg",
    title: 'Shoes Waste',
    about:
        'The problem is that shoes are inherently difficult to recycle. They can be made of a wide variety of materials, often spanning up to 40 different components, making it challenging to take shoes apart and recycle each piece accordingly. Additionally, there are a limited number of facilities that can cater to shoe recycling. The end result is that around 90% of the shoes we wear eventually end up in landfills.',
    methods: '''
  ...
  Detail(
    photo: "https://d3pcsg2wjq9izr.cloudfront.net/files/39876/products/623003/39876_2_202007242359517930351.jpg",
    title: 'Trash',
    about:
        'General waste bin is the place for items that you would usually throw into the general waste bin at home. These are things that you wouldn’t usually recycle, and that often end up in landfill. Where possible, you should separate your waste to maximise recycling opportunities.',
    methods:
  ...
  Detail(
    photo: "https://ismwaste.co.uk/images/recycling/glass-min.jpg",
